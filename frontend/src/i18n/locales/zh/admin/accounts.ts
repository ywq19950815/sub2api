export default {
    accounts: {
      ...
      dataActions: '数据操作',
      toolActions: '工具',
      batchTestLiveness: '一键测活',
      batchTestLivenessConfirm: '将测试当前筛选条件下的全部账号。测试失败的账号会被标记为错误并停止调度，是否继续？',
      batchTestLivenessResult: '测活完成：共 {total} 个，存活 {alive} 个，异常 {dead} 个',
      batchTestLivenessUpdateFailed: '{count} 个异常账号未能写入错误状态。',
      livenessPanelTitle: '批量测活进度',
      livenessRunning: '后台测活进行中，可继续浏览其它页面',
      livenessCompleted: '测活已完成',
      livenessMinimize: '最小化',
      livenessCurrent: '正在处理账号 #{id}',
      livenessAlive: '存活',
      livenessDead: '异常',
      livenessDeadShort: '异常',
      livenessPending: '待测',
      livenessRecent: '最近结果',
      livenessDeleteFailed: '删除本次异常账号 ({count})',
      livenessDeleteConfirm: '确认删除本次测活发现的 {count} 个异常账号吗？此操作不可恢复。',
      livenessDeleteResult: '已删除 {deleted} 个异常账号，失败 {failed} 个。',
      livenessFinishedHint: '本次没有需要删除的异常账号。',
      viewColumns: '列显示',
