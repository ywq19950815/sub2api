export default {
    accounts: {
      ...
      dataActions: 'Data',
      toolActions: 'Tools',
      batchTestLiveness: 'Test All Accounts',
      batchTestLivenessConfirm: 'This tests every account matching the current filters. Failed accounts will be marked as errors and made unschedulable. Continue?',
      batchTestLivenessResult: 'Liveness test completed: {total} total, {alive} alive, {dead} failed',
      batchTestLivenessUpdateFailed: 'Unable to mark {count} failed account(s) as errors.',
      livenessPanelTitle: 'Batch Liveness Progress',
      livenessRunning: 'Running in the background. You can keep browsing.',
      livenessCompleted: 'Liveness test completed',
      livenessMinimize: 'Minimize',
      livenessCurrent: 'Testing account #{id}',
      livenessAlive: 'Alive',
      livenessDead: 'Failed',
      livenessDeadShort: 'failed',
      livenessPending: 'Pending',
      livenessRecent: 'Recent results',
      livenessDeleteFailed: 'Delete failed accounts ({count})',
      livenessDeleteConfirm: 'Delete the {count} accounts that failed this liveness test? This cannot be undone.',
      livenessDeleteResult: 'Deleted {deleted} failed account(s), {failed} failed to delete.',
      livenessFinishedHint: 'No failed accounts remain to delete.',
      viewColumns: 'Columns',
